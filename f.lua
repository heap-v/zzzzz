...
local serv = win:Server("Nicos Nextbot", "http://www.roblox.com/asset/?id=10625450160") -- Create new server
...
elseif game.PlaceId == 5911084042 then
    ...
    local serv = win:Server("Flerix Hub", "") -- Create new server
...
local tgls = serv:Channel("main") -- New channel in server

tgls:Toggle("Infinite Money",
    false,
    function(bool)
        getgenv().infmoney = bool
    if bool then
        getgenv().infmoney = bool
    while getgenv().infmoney == true do
    wait(.1)
...
tgls:Toggle("Infinite Water",
    false,
    function(bool)
        getgenv().infwater = bool -- [name] = id
        print('water is: ', bool);
    if bool then
        getgenv().infwater = bool
    while getgenv().infwater == true do
        wait(.1)
...
local serv = win:Server("Criminality"), ("") -- Create new server

local tgls = serv:Channel("General") -- New channel in server

tgls:Toggle("Aimbot"),
loadstring(game:HttpGet("https://pastebin.com/rpM0k2PN", true))()

 = tgls:Seperator()
  
tgls:Toggle("Scrap ESP"),
loadstring(game:HttpGet("https://raw.githubusercontent.com/heap-v/FlerixHub/main/zzz.lua", true))()

    tgls:Toggle("Tool ESP",
for __,v in pairs(game.Workspace.Filter.SpawnedTools:GetChildren()) do
...
c.BorderSizePixel = 0
    ...
    tgls:Toggle("Cash ESP",
for __,v in pairs(game.Workspace.Filter.SpawnedCash:GetChildren()) do
if v:IsA("Model") or v:IsA("Part") or v:IsA("MeshPart") then
local a = Instance.new("BillboardGui",v)
a.Size = UDim2.new(1,0, 1,0)
a.Name = "A"
...
c.BorderSizePixel = 0
 ...
 tgls:Toggle("Register ESP",        
for __,v in pairs(game.Workspace.Map.CashRegisters:GetChildren()) do
if v:IsA("Model") or v:IsA("Part") or v:IsA("MeshPart") then
local a = Instance.new("BillboardGui",v)
a.Size = UDim2.new(1,0, 1,0)
a.Name = "A"
